...
export default function ChallengeDetail() {
  ...
  const handleRetract = () => {
    Swal.fire("Your request for retraction is being processed!");
  };

  const handleDownVote = () => {
    Swal.fire("Your request for dismissal is being processed!");
  };
  ...
  return (
    <>
      <div className="container w-max md:max-w-4xl mx-auto pt-20">
        ...
        <div className="flex gap-2 text-center p-2 px-4 md:px-6 ">
          <button
